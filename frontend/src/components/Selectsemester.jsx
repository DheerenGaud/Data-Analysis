    ...
    <Grid container spacing={1} alignItems="center" direction={"row"}>
      ...
      <Grid item xs={4} md={4} className="pageStyle">
        <MonthYearSelect
          name="ExternalYear"
          value={extrY}
          onChange={onChangeextrY}
        />
      </Grid>
      <Grid item xs={4} md={3} className="pageStyle">
        {Final_Revaluation === true ? (
          <Radio disabled={true} checked={Final_Revaluation} />
        ) : (
      ...
      <Box display="flex" alignItems="center" flexDirection="row">
        <Typography>T | {genderCount.T}</Typography>
        <Box marginLeft={3}>
          <Typography>M | {genderCount.M}</Typography>
        </Box>
        <Box marginLeft={3}>
          <Typography>F | {genderCount.F}</Typography>
        </Box>
        <Box marginLeft={3}>
          <Typography>O | {genderCount.O}</Typography>
        </Box>
      </Box>
    </Grid>
  );
